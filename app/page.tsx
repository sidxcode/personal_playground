export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      <div className="content bg-green-500 mx-auto flex w-full max-w-[800px] flex-col gap-y-4 px-[20px] md:flex-row md:justify-between">
        <div className="description w-full md:w-[400px] px-4">
          ...
          <div className="py-2 text-[#2a2a2a]">
            ...
            <p className="text-[18px]"><a className="text-red-500" href="mailto:me@siddharthborman.xyz">mail</a><a className="text-red-500" href="https://x.com/siddharthborman"></a>, <a className="text-red-500" href="#">x</a>, <a className="text-red-500" href="#">instagram</a></p>
          </div>
        </div>
        <div className="gallery w-full h-fit grid grid-cols-1 gap-4">
          <div className="w-full aspect-[4/3] bg-blue-500"></div>
          <div className="w-full aspect-[4/3] bg-blue-500"></div>
          <div className="w-full aspect-[4/3] bg-blue-500"></div>
        </div>
      </div>
